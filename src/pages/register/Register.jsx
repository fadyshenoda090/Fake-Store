...
const Register = () => {
  return (
    <section className='w-full flex justify-center px-3 py-28'>
      <div className='w-[60vw] flex flex-col justify-center items-center bg-slate-100 dark:bg-[#403546] shadow-lg shadow-slate-400 dark:shadow-slate-500 p-5'>
        <h2 className='text-3xl font-bold text-center dark:text-white mb-3'>Create An Account</h2>
        <form autoComplete='off' className='w-full flex flex-col justify-center items-center px-3'>
          <div className='flex flex-col md:flex-row md:gap-5 justify-between w-full'>
            <div className='w-full'>
              <label htmlFor="fName" className='text-lg font-semibold dark:text-white'>First name</label>
              <input id='fName' className='bg-white w-full h-10 mb-5 p-2 rounded-lg outline-none' type="text" placeholder='First Name' />
            </div>
            <div className='w-full'>
              <label htmlFor="lName" className='text-lg font-semibold dark:text-white'>Last name</label>
              <input id='lName' className='bg-white w-full h-10 mb-5 p-2 rounded-lg outline-none' type="text" placeholder='Last Name' />
            </div>
          </div>
          <div>
            <label htmlFor="email" className='text-lg font-semibold dark:text-white'>E-mail</label>
